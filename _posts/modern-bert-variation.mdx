...
date: 2025-03-27
excerpt: Can we teach a language model how to understand chess through Portable Game Notation (PGN)?
author:
  name: Eric Allen
...
If you want to play around with the tokenizer, [all of the code is open-source](https://github.com/DVDAGames/pgn-tokenizer)[, the Python library is published to PyPI as [`pgn-tokenizer`](https://pypi.org/project/pgn-tokenizer/), and a beta version of the TypeScript library is published to npm as [`@dvdagames/pgn-tokenizer](<. The Python library is published to PyPI as [`pgn-tokenizer`](https://pypi.org/project/pgn-tokenizer/). A beta version of the TypeScript library is published to npm as [`@dvdagames/png>)`](https://www.npmjs.com/package/@dvdagames/pgn-tokenizer).
